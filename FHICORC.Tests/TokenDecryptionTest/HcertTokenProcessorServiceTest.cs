    ...
    public class HcertTokenProcessorServiceTest
    {
        ...
        public async Task TestDecode_CanDecode_EC256()
        {
            ...
            string prefixCompressedCose =
                "HC1:NCFOXN%TS3DH3ZSUZK+.V0ETD%65NL-AH+VEIOO6+IY3U:O2GJL0K5WMA+QI6M8SA3/-2E%5TR5ZVBFVAPUB1VCSWC%PDGZKBTC$JC6VCQVD. CL%2IZI+BJ*8DVWDVTAUPIAK29VC4/D-FD8RD5VA2TBQMISVBYIJ33M+ZJ83BTKBG42$IJH7J*CL0DJ WJ3R6N95SWMA46HHP4F5G+P%YQ+GOBPPN*O8-RL1RMHPW+QK0P5IR1OR1NPG-RSGOV0QB+PRNQFNQU+QW/QXKRAC5ADNIQR8L6IWMW KAHA508XIORW6%5LXM8+LOUO2:NIQBJ4OIMEDTJCJKDLEDL9C9N0*969L6-96QW6U46Q3QR$P2OIC0JVLA8J3ET3:H3A+2+33U SAAUOT3TPTO4UBZIC0JKQTRQ6Q+M3+L IMXDRHJUXYOEGGJ0AWH9P8Q/KPP4FCH1GZEPEEQK9FWP51AJI5-V90C9G%5TW5A 6 O6$L69/9-3AKI6LP02J34S6172NLRCRKDV3.IFV-RM9KQO8 8RHCU3%N3JL4/F44CFQK7*G.3O6PMA04O7Q6:KMBDS/L:9AYO42L3UIVKNRCEQ4UQQCV$9L3.2PFW:GK/S1NZS08J";
        ...
        public async Task TestDecode_CanDecode_RSA2048()
        {
            //This test does not validate the signature, it just test the decoding part
            string prefixCompressedCose =
                "HC1:NCFG70HF0/3WUWGVLKE99.9RBVE4FTGCDH479CK$603XK2F308RFQT2F30%QAQT/IC6TAY50.FK6ZK7:EDOLFVC*70B$D% D3IA4W5646946846.966KCN9E%961A6DL6FA7D46XJCCWENF6OF63W5KF60A6WJCT3ETB8WJC0FDTA6AIA%G7X+AQB9746IG77TA$96T476:6/Q6M*8CR63Y8R46WX8F46VL6/G8SF6DR64S8+96QK4.JCP9EJY8L/5M/5546.96VF6%JC+QEEK3ZED+EDKWE3EFX3ET34X C:VDS7DM347%EKWEMED3KC.SC4KCD3DX47B46IL6646I*6..DX%DLPCG/DE$EIZAITA2IA.HA+YAU09HY8 NAE+9GY8ZJCH/DTZ9 QE5$C .CJECQW5HXO*WOZED93DXKEI3DAWEG09DH8$B9+S9 JC4/D3192KCQEDTVD$PC5$CUZC $5Z$5JPCT3E5JDOA7Q478465W58*6V506FG.-9OT0WLGCQPY:IP LFQLA1968N:*JYFEI*TQ6QFU7/3PJBKO7MBBIZ3EHSGKF6TD1C$MQ7O1MKWWD8Q6Q$RWADNZHO-5VT209FYUH-/EUV72LC8HI7P5MZGX4S.C9T75 Y3V*G5WTVTEZM00$HGRJUZ63$89GLK$V4*UY22O.T4FBIEI.R89.TQ4HV/6UTV6MK-F4EHB 1W.$IV:P+Z6+1327V2-1+X19SEQASZ 77Q27 LZRH V810RA.QOURBGG289YVARKKN1SH4O.9KYV948UNNORBHXQQK1GSR5HT4$Y6039BGVA4KJ+LEBKL$PDDDQPEO5MO40Z$9D0T*IRB1G6LDSNV$XJVK9JF3S5NJ75GU0$DC.KG5*1MOTXZA01U";
            var result =  await verifier.DecodePassportTokenToModel(prefixCompressedCose);
            //because this token is expired
            Assert.AreNotEqual(result.ValidationResult, TokenValidateResult.Invalid);
        } 
